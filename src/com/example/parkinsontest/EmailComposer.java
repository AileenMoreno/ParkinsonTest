...
package com.example.parkinsontest;
...
public class EmailComposer extends CordovaPlugin {
    ...
    private void sendEmail(JSONObject parameters, CallbackContext callbackContext) {
        ...
        try {
            ...
            Log.e(LOG_TAG, "Error handling isHTML param: " + e.toString());
        }
        ...
        try {
            ...
            Log.e(LOG_TAG, "Error handling body param: " + e.toString());
        }
        ...
        try {
            ...
            Log.e(LOG_TAG, "Error handling toRecipients param: " + e.toString());
        }
        ...
        try {
            ...
            Log.e(LOG_TAG, "Error handling bccRecipients param: " + e.toString());
        }
        ...
        try {
            ...
            if (attachments != null && attachments.length() > 0) {
                ...
                for (int i = 0; i < attachments.length(); i++) {
                    try {
                        ...
                        Log.e(LOG_TAG, "Error adding an attachment: " + e.toString());
                    }
                }
                if (uris.size() > 0) {
            ...
            Log.e(LOG_TAG, "Error handling attachments param: " + e.toString());
        }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        this._callbackContext.success(obj);
    }
